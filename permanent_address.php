...
if(isset($_POST['permanent_address'])){
	...
	$query="INSERT INTO `permanent_address_5` (`house_no`,`village`,`state_ut`,`district`,`police_station`,`pin`,`mobile`,`email`,`app_id`) VALUES ('$house_no','$village','$state_ut','$district','$police_station','$pin','$mobile','$email','$app_id') ";
 ...
 ?>
<!-- <div class="container"> -->
<h2>Permanent Residential Address</h2>
<div class="jumbotron">
	<form action="" method="POST">
		...
		<div class="form-group">
	        <div class="col-sm-3 col-sm-offset-1">
	  	   		<button type="submit" class="btn btn-primary form-control" name="permanent_address">Next>></button>
	       	</div>
	    </div> 
	</form>
	<!-- </div> -->
