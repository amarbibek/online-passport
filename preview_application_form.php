...
<div id="button">
	<div class="col-md-3">
		<button type="button" class="btn btn-primary form-control " name="print" onclick="prints();">Print Details</button>
	</div>
	<div class="col-md-3">
		<a href="make_payment.php?app_id=<?php echo $app_id; ?>" type="button" class="btn btn-primary form-control "  >Make Payment</a>
	</div>
</div>
